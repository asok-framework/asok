...
class Countries:
    ...
    @staticmethod
    def distance(lat1: float, lon1: float, lat2: float, lon2: float, unit: str = "km") -> float:
    ...
    @staticmethod
    def static_map(lat: float, lon: float, zoom: int = 13, size: str = "600x300", provider: str = "osm") -> str:
    ...
    def get_timezone(iso_code: str) -> str:
        ...
        zones = {
            "FR": "Europe/Paris", "US": "America/New_York", "GB": "Europe/London",
            "DE": "Europe/Berlin", "JP": "Asia/Tokyo", "CN": "Asia/Shanghai",
            "IN": "Asia/Kolkata", "BR": "America/Sao_Paulo", "RU": "Europe/Moscow",
...
def get_dial_codes() -> list[tuple[str, str, str, str, str, str, str]]:
    ...
    return [
        ...
        ("AS", "+1-684", "American Samoa", "Pago Pago", "Oceania", "USD", "English, Samoan"),
        ...
        ("AG", "+1-268", "Antigua and Barbuda", "Saint John's", "North America", "XCD", "English"),
        ("AR", "+54", "Argentina", "Buenos Aires", "South America", "ARS", "Spanish"),
        ("AM", "+374", "Armenia", "Yerevan", "Asia", "AMD", "Armenian"),
        ("AW", "+297", "Aruba", "Oranjestad", "North America", "AWG", "Dutch, Papiamento"),
        ...
        ("BO", "+591", "Bolivia", "Sucre", "South America", "BOB", "Spanish, Quechua, Aymara"),
        ("BQ", "+599", "Bonaire", "Kralendijk", "North America", "USD", "Dutch, Papiamento"),
        ("BA", "+387", "Bosnia and Herzegovina", "Sarajevo", "Europe", "BAM", "Bosnian, Croatian, Serbian"),
        ...
        ("IO", "+246", "British Indian Ocean Territory", "Diego Garcia", "Africa", "USD", "English"),
        ...
        ("BI", "+257", "Burundi", "Gitega", "Africa", "BIF", "Kirundi, French, English"),
        ...
        ("KY", "+1-345", "Cayman Islands", "George Town", "North America", "KYD", "English"),
        ("CF", "+236", "Central African Republic", "Bangui", "Africa", "XAF", "Sango, French"),
        ...
        ("CX", "+61", "Christmas Island", "Flying Fish Cove", "Oceania", "AUD", "English"),
        ("CC", "+61", "Cocos (Keeling) Islands", "West Island", "Oceania", "AUD", "English"),
        ("CO", "+57", "Colombia", "Bogota", "South America", "COP", "Spanish"),
        ("KM", "+269", "Comoros", "Moroni", "Africa", "KMF", "Arabic, French, Comorian"),
        ("CG", "+242", "Congo", "Brazzaville", "Africa", "XAF", "French"),
        ("CD", "+243", "Congo, Democratic Republic of the", "Kinshasa", "Africa", "CDF", "French"),
        ("CK", "+682", "Cook Islands", "Avarua", "Oceania", "NZD", "English, Cook Islands Maori"),
        ...
        ("CW", "+599", "Curacao", "Willemstad", "North America", "ANG", "Dutch, Papiamento"),
        ...
        ("DO", "+1", "Dominican Republic", "Santo Domingo", "North America", "DOP", "Spanish"),
        ("EC", "+593", "Ecuador", "Quito", "South America", "USD", "Spanish"),
        ("EG", "+20", "Egypt", "Cairo", "Africa", "EGP", "Arabic"),
        ("SV", "+503", "El Salvador", "San Salvador", "North America", "USD", "Spanish"),
        ("GQ", "+240", "Equatorial Guinea", "Malabo", "Africa", "XAF", "Spanish, French, Portuguese"),
        ("ER", "+291", "Eritrea", "Asmara", "Africa", "ERN", "Tigrinya, Arabic, English"),
        ("EE", "+372", "Estonia", "Tallinn", "Europe", "EUR", "Estonian"),
        ("ET", "+251", "Ethiopia", "Addis Ababa", "Africa", "ETB", "Amharic"),
        ("FK", "+500", "Falkland Islands", "Stanley", "South America", "FKP", "English"),
        ...
        ("TF", "+262", "French Southern Territories", "Port-aux-Francais", "Antarctica", "EUR", "French"),
        ...
        ("GD", "+1-473", "Grenada", "Saint George's", "North America", "XCD", "English"),
        ("GP", "+590", "Guadeloupe", "Basse-Terre", "North America", "EUR", "French"),
        ("GU", "+1-671", "Guam", "Hagatna", "Oceania", "USD", "English, Chamorro"),
        ("GT", "+502", "Guatemala", "Guatemala City", "North America", "GTQ", "Spanish"),
        ...
        ("HT", "+509", "Haiti", "Port-au-Prince", "North America", "HTG", "French, Haitian Creole"),
        ("HM", "+672", "Heard and McDonald Islands", "None", "Antarctica", "AUD", "None"),
        ("VA", "+379", "Vatican City", "Vatican City", "Europe", "EUR", "Italian, Latin"),
        ...
        ("KI", "+686", "Kiribati", "South Tarawa", "Oceania", "AUD", "English, Gilbertese"),
        ...
        ("LU", "+352", "Luxembourg", "Luxembourg", "Europe", "EUR", "French, German, Luxembourgish"),
        ("MO", "+853", "Macao", "Macao", "Asia", "MOP", "Chinese, Portuguese"),
        ("MK", "+389", "North Macedonia", "Skopje", "Europe", "MKD", "Macedonian"),
        ("MG", "+261", "Madagascar", "Antananarivo", "Africa", "MGA", "Malagasy, French"),
        ...
        ("MH", "+692", "Marshall Islands", "Majuro", "Oceania", "USD", "English, Marshallese"),
        ("MQ", "+596", "Martinique", "Fort-de-France", "North America", "EUR", "French"),
        ...
        ("NA", "+264", "Namibia", "Windhoek", "Africa", "NAD, ZAR", "English, Afrikaans, German"),
        ...
        ("NF", "+672", "Norfolk Island", "Kingston", "Oceania", "AUD", "English, Norfuk"),
        ("MP", "+1-670", "Northern Mariana Islands", "Saipan", "Oceania", "USD", "English, Chamorro"),
        ...
        ("PG", "+675", "Papua New Guinea", "Port Moresby", "Oceania", "PGK", "English, Tok Pisin, Hiri Motu"),
        ("PY", "+595", "Paraguay", "Asuncion", "South America", "PYG", "Spanish, Guarani"),
        ...
        ("PR", "+1-787", "Puerto Rico", "San Juan", "North America", "USD", "Spanish, English"),
        ...
        ("RW", "+250", "Rwanda", "Kigali", "Africa", "RWF", "Kinyarwanda, French, English"),
        ("BL", "+590", "Saint Barthelemy", "Gustavia", "North America", "EUR", "French"),
        ("SH", "+290", "Saint Helena", "Jamestown", "Africa", "SHP", "English"),
        ("KN", "+1-869", "Saint Kitts and Nevis", "Basseterre", "North America", "XCD", "English"),
        ("LC", "+1-758", "Saint Lucia", "Castries", "North America", "XCD", "English"),
        ("MF", "+590", "Saint Martin", "Marigot", "North America", "EUR", "French"),
        ("PM", "+508", "Saint Pierre and Miquelon", "Saint-Pierre", "North America", "EUR", "French"),
        ("VC", "+1-784", "Saint Vincent and the Grenadines", "Kingstown", "North America", "XCD", "English"),
        ("WS", "+685", "Samoa", "Apia", "Oceania", "WST", "Samoan, English"),
        ("SM", "+378", "San Marino", "San Marino", "Europe", "EUR", "Italian"),
        ("ST", "+239", "Sao Tome and Principe", "Sao Tome", "Africa", "STN", "Portuguese"),
        ...
        ("SC", "+248", "Seychelles", "Victoria", "Africa", "SCR", "Seychellois Creole, English, French"),
        ("SL", "+232", "Sierra Leone", "Freetown", "Africa", "SLL", "English"),
        ("SG", "+65", "Singapore", "Singapore", "Asia", "SGD", "English, Malay, Mandarin, Tamil"),
        ("SX", "+1-721", "Sint Maarten", "Philipsburg", "North America", "ANG", "Dutch, English"),
        ...
        ("ZA", "+27", "South Africa", "Pretoria", "Africa", "ZAR", "Zulu, Xhosa, Afrikaans, English..."),
        ("GS", "+500", "South Georgia", "King Edward Point", "Antarctica", "GBP", "English"),
        ...
        ("SJ", "+47", "Svalbard and Jan Mayen", "Longyearbyen", "Europe", "NOK", "Norwegian"),
        ("SZ", "+268", "Eswatini", "Mbabane", "Africa", "SZL", "English, Swazi"),
        ("SE", "+46", "Sweden", "Stockholm", "Europe", "SEK", "Swedish"),
        ("CH", "+41", "Switzerland", "Bern", "Europe", "CHF", "German, French, Italian, Romansh"),
        ...
        ("TT", "+1-868", "Trinidad and Tobago", "Port of Spain", "North America", "TTD", "English"),
        ...
        ("TC", "+1-649", "Turks and Caicos Islands", "Cockburn Town", "North America", "USD", "English"),
        ...
        ("US", "+1", "United States", "Washington, D.C.", "North America", "USD", "English"),
        ("UM", "+1", "United States Minor Outlying Islands", "None", "Oceania", "USD", "English"),
        ("UY", "+598", "Uruguay", "Montevideo", "South America", "UYU", "Spanish"),
        ("UZ", "+998", "Uzbekistan", "Tashkent", "Asia", "UZS", "Uzbek"),
        ("VU", "+678", "Vanuatu", "Port Vila", "Oceania", "VUV", "Bislama, English, French"),
        ("VE", "+58", "Venezuela", "Caracas", "South America", "VES", "Spanish"),
        ("VN", "+84", "Vietnam", "Hanoi", "Asia", "VND", "Vietnamese"),
        ("VG", "+1-284", "British Virgin Islands", "Road Town", "North America", "USD", "English"),
        ("VI", "+1-340", "U.S. Virgin Islands", "Charlotte Amalie", "North America", "USD", "English"),
        ("WF", "+681", "Wallis and Futuna", "Mata-Utu", "Oceania", "XPF", "French"),
        ("EH", "+212", "Western Sahara", "Laayoune", "Africa", "MAD", "Arabic, Berber, Spanish"),
        ("YE", "+967", "Yemen", "Sanaa", "Asia", "YER", "Arabic"),
        ("ZM", "+260", "Zambia", "Lusaka", "Africa", "ZMW", "English"),
        ("ZW", "+263", "Zimbabwe", "Harare", "Africa", "ZWL", "English, Shona, Ndebele"),
    ]
