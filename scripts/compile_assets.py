...
from asok.cli.tools import assets_install
...
def compile_assets():
    ...
    for asset_dir in dirs_to_compile:
        ...
        for filename in os.listdir(asset_dir):
            if (filename.endswith(".js") or filename.endswith(".css")) and not (filename.endswith(".min.js") or filename.endswith(".min.css")):
