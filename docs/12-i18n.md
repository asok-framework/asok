...
Form labels and validation errors are translatable. See [Forms > i18n](06-forms.md#translating-labels-i18n) and [Validation > i18n](07-validation.md#i18n).
...
---
[← Previous: Cache](11-cache.md) | [Documentation](README.md) | [Next: Testing →](13-testing.md)
